...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1_Ethernet8 | routed | - | 192.168.103.41/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2_Ethernet8 | routed | - | 192.168.103.43/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3_Ethernet8 | routed | - | 192.168.103.45/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_LINK_TO_SPINE4_Ethernet8 | routed | - | 192.168.103.47/31 | default | 1500 | False | - | - |
| Ethernet7 | - | routed | - | 10.1.4.1/24 | VRF_A | - | False | - | - |
...
router bgp 65192
   ...
   vrf VRF_A
      ...
      router-id 192.168.101.6
      neighbor 10.1.4.254 remote-as 1
